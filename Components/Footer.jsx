...
const Footer = () => {
    ...
    return (
        ...
        (pathname === "/onBoard" || pathname === "/login") ? (
        null
          ...
          <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                  <a href="/" className="flex items-center">
                      <img src="/assests/sigmaRedLogo.svg" className="h-8 mr-3" alt="Sigmanode Logo" />
                      {/* <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Sigmanode</span> */}
                  </a>
              </div>

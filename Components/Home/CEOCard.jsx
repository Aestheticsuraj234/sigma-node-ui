...
const CEOCard = () => {
  return (
    <div className="w-full glassmorphism flex md:flex-row flex-col border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-16 mb-16">
      ...
      <div>
        <div className="p-4 rounded-lg md:p-8 dark:bg-gray-600">
          <h2 className="mb-3 md:text-3xl text-2xl  font-extrabold tracking-tight text-gray-600 dark:text-white">Founder & CEO <span className="bg-gradient-to-r from-rose-700 to-pink-600 bg-clip-text text-transparent">SIGMANODE</span></h2>
          <p className="mb-3 text-md text-gray-500 dark:text-gray-400">Supercharge your software development journey with Sigma-Node! Join a vibrant community of like-minded developers for unparalleled knowledge sharing, collaboration, and inspiration. Discover thought-provoking posts, insightful blogs, bite-sized shorts, and engaging podcasts that keep you on the forefront of tech news and trends. Elevate your skills and stay ahead of the curve. Join Sigma-Node today!</p>

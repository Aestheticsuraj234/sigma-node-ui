...
const MoreFeature = () => {
  ...
  return (
    <section className=' glassmorphism flex w-[100%]  flex-col p-4 mt-12 rounded-lg max-w-full '>
      <h4 className='items-center justify-center  flex text-center font-bold text-md  text-rose-600 '>FOCUS ON CREATING, WHILE WE DO THE REST</h4>
      <h1 className='items-center justify-center flex text-center mt-9 font-extrabold md:text-4xl text-3xl  text-gray-800'>Features that make tech Content Creating</h1>
